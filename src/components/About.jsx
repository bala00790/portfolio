  ...
  return (
    <div className='bg-black text-which py-20 h-screen flex items-center justify-center flex-col' id='about'> 
      <div className='container mx-auto px-8 md:px-16 lg:px-24 '>
        <h2 className='text-4xl font-bold text-center text-white mb-12 mt-15'>About Me</h2>
        <div className='flex flex-col md:flex-row items-center md:space-x-12'>
            <img src={AboutImage} alt=""  
            className='w-72 h-80 rounded object-cover mt-28 mr-20 md:mb-0'/>
            ...
            <div className='space-y-7'>
                ...
                <div className='flex items-center'>
                    <label htmlFor="htmlandcss" className='w-12/12 text-white'>
                    CSS</label>
                <div className='bg-gray-800 rounded-full w-3/5 h-2.5 ml-12'>
                     <div className='bg-gradient-to-r from-green-400 to-blue-500 h-2.5 rounded-full
                    transform transition-transform duration-300 hover:scale-105 w-10/12'>
                     </div> 
                </div>
                ...
                <div className='flex items-center'>
                    <label htmlFor="htmlandcss" className='w-12/12 text-white'>
                    React JS</label>
                <div className='bg-gray-800 rounded-full w-3/5 h-2.5 ml-11'>
                     <div className='bg-gradient-to-r from-green-400 to-blue-500 h-2.5 rounded-full
                    transform transition-transform duration-300 hover:scale-105 w-10/12'>
                     </div> 
                </div>
                ...
                <div className='flex items-center'>
                    <label htmlFor="htmlandcss" className='w-12/12 text-white'>
                    MongoDB</label>
                <div className='bg-gray-800 rounded-full w-3/5 h-2.5 ml-8'>
                     <div className='bg-gradient-to-r from-green-400 to-blue-500 h-2.5 rounded-full
                    transform transition-transform duration-300 hover:scale-105 w-10/12'>
                     </div> 
                </div>
